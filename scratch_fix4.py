...
# Wrap each block with conditional logic

def wrap_block(content, start_str, end_str, condition):
...
# For Site Notification Bar
# It goes from the start of Site Notification Bar until `          </div>\n        </div>\n      )}\n\n      {activeTab === 'Settings' && (`
...
# Move the Dropdown block to the top
